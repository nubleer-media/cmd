...
import (
	...
	"github.com/nubleer/revel/harness"
	"github.com/nubleer/revel/modules/testrunner/app/controllers"
	"io"
	"io/ioutil"
	"net/http"
	"os"
...
For example, to run the booking sample application's tests:
    ...
    revel test github.com/nubleer/revel/samples/booking dev
...
func testApp(args []string) {
	...
	for _, module := range revel.Modules {
		if module.ImportPath == "github.com/nubleer/revel/modules/testrunner" {
...
You can add it to a run mode configuration with the following line:
	...
	module.testrunner = github.com/nubleer/revel/modules/testrunner
